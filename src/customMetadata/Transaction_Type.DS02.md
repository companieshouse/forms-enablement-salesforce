...
<CustomMetadata xmlns="http://soap.sforce.com/2006/04/metadata" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
    <label>DS02 - Dissolution Withdrawal</label>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">You may use this form to withdraw a company’s striking off application.

What this form is NOT for
You cannot use this form to: - withdraw a striking off application by a Limited Liability Partnership (LLP).</value>
    </values>
    <values>
        <field>Landing_Page_Title__c</field>
        <value xsi:type="xsd:string">DS02 - Withdrawal of striking off application by company</value>
    </values>
    <values>
